                ...
                <div class="container-fluid">
                    <div class="my-5">
                        ...
                        <form method="post">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" value="<?php echo $row['usersName']; ?>" required>
                            </div>
                            <label class="col-md-3 col-form-label">Email:</label>
                            <div class="col-md-6">
                                <input type="email" class="form-control" name="email" value="<?php echo $row['usersEmail']; ?>" required>
                            </div>
                            <label class="col-md-3 col-form-label">Username:</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="username" value="<?php echo $row['usersUid']; ?>" required>
                            </div>
