...
<head>
    ...
    <title>List of License Plate Information</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2>List of Cars</h2>
                    <a class="btn btn-primary" href="CRUDLPI/Create.php" role="button">Add License Plates</a>
                    <br>
                    .<table class="table">
                        <!-- Table head -->
                        <thead>
                        ...
                        <tbody>
                            ...
                            // Query
                            $sql = "SELECT * FROM listlicenseplate";
                            //saving the query 
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "
                                    <tr>
                                        ...
                                        <td>
                                            <a class='btn btn-primary' href='CRUDLPI/Edit.php?Num_id=$row[Num_id]'>Edit</a>
                                            <a class='btn btn-danger' href='CRUDLPI/Delete.php?Num_id=$row[Num_id]'>Delete</a>
                                        </td>
                                    </tr> 
                                ";
                            }
