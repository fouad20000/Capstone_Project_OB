...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql = "SELECT * FROM listlicenseplate WHERE Num_id=$id";
    ...
    do {
        $sql = "UPDATE listlicenseplate SET licenseplatenumber='$name' WHERE Num_id=$id";
        $result = $conn->query($sql);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="my-5">
                        ...
                        <form method="post">
                            <input type="hidden" name="id" value="<?php echo $row['Num_id']; ?>" required>
                            <label class="col-md-3 col-form-label">Name:</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" value="<?php echo $row['licenseplatenumber']; ?>" required>
                            </div>
                            <br>
                            <div class="row mb-4 ">
                                <div class="col-md-4 m-lg-2">
                                    <button type="update_submit" class="btn btn-primary">Edit the License Plate</button>
                                    <br>
                                </div>
                                <div class="col-md-2 m-lg-2">
                                    <button class="btn btn-danger"><a href="../LPI.php" class="text-white">Cancel</a></button>
                                </div>
                            </div>
                        </form>
