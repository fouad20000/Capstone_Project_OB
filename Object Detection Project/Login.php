...
<body>
    ...
    <section class="signup-form text-primary bg-light">
        ...
        <h2 class="text-center"><b>Login Page</b></h2>
        <form action="Login_System/login.inc.php" method="post">
            <div class="container col-md-3 mt-5">
                <label for="Full name" class="form-label row"><b>Username/Email:</b></label>
                ...
                <div class="">
                    ...
                    if (isset($_GET["error"])) {
                        if ($_GET["error"] == "emptyinput") {
                            ...
                            echo "<p>Please enter the password again !</p>";
                        }
                    }
                    ?>
                </div>
